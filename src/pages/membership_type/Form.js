...
class App extends Component {
        ...
        RetrieveRequest(url, criteria).then((response) => {
            ...
            if (status.responsecode.substring(0, 1) === '0') {
                if (result.length !== 0) {
                    ...
                    let setValue = { membershiptypeid, membershiptypename };
    ...
    render() {
        ...
        if (formrender) {
            ...
            document.title = titlepage + " Membership Type | Loyalty Management System";
            //render form
            return (
                <Row>
                    <Row>
                        <Col xs={24} xl={22}>
                            <Title level={3}>{titlepage} Membership Type</Title>
                        </Col>
                        <Divider />
                    </Row>
                        ...
                        <Form {...formItemLayout} onSubmit={this.saveAction}>
                            <Row gutter={24}>
                                <Col className="gutter-row" xs={24} sm={24} md={24} lg={{ span: 12, offset: 4 }} xl={{ span: 12, offset: 4 }}>
                                    <InputText form={this.props.form} labeltext="Code" datafield="membershiptypeid" validationrules={['required', 'pattern.alphanumeric', 'max.20',]} maxLength="20" disabled={specialfielddisabled} />
                                    <InputText form={this.props.form} labeltext="Name" datafield="membershiptypename" validationrules={['required', 'pattern.alphanumericspace', 'max.45',]} maxLength="45" disabled={generalfielddisabled} />
                                </Col>
                            </Row>
                            <Row gutter={24} type="flex" justify="center" style={{ marginTop: 10 }}>
                                ...
                                <Button url="/membership-type" htmlType="link" type="default" label="Back" />
                            </Row>
                        </Form>
                    </Spin>
                </Row>
