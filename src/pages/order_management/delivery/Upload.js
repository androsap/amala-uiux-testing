...
class App extends Component {
    ...
    handleDownload = (e, type) => {
        if (type === 'delivered') window.location.href = 'https://amala-pdt.garuda-indonesia.com/uploads/ordertemplate/delivery.xlsx';
        if (type === 'return') window.location.href = 'https://amala-pdt.garuda-indonesia.com/uploads/ordertemplate/return.xlsx';
    };
    ...
    saveAction = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, input) => {
            if (!err) {
                ...
                let url = api.url.delivery.upload;
            ...
            <React.Fragment>
                ...
                <Spin spinning={isLoading}>
                    <Form onSubmit={this.saveAction} {...formItemLayout}>
                        <Row gutter={24}>
                            <Col className='gutter-row' xs={24} sm={12} md={12} lg={{ span: 9, offset: 3 }} xl={{ span: 9, offset: 3 }}>
                            ...
                            <Col className='gutter-row' xs={24} sm={12} md={12} lg={{ span: 8 }} xl={{ span: 8 }} style={{ marginTop: 4, paddingLeft: 0 }}>
                        ...
                        <Row gutter={24} type='flex' justify='center' style={{ marginTop: 10 }}>
                            <Button htmlType='button' type='default' label='Download Template Delivered (.xlsx)' onClick={(e) => this.handleDownload(e, 'delivered')} />
                            <Button htmlType='button' type='default' label='Download Template Return (.xlsx)' onClick={(e) => this.handleDownload(e, 'return')} />
                        </Row>
                    </Form>
                </Spin>
            </React.Fragment>
