...
class App extends React.Component {
    ...
    componentDidMount = async () => {
        document.title = "Performance Report | Loyalty Management System";
    };
                ...
                <Layout>
                    <Layout.Content style={{ minHeight: 500, background: '#fff' }}>
                        <Iframe id='embeddedIframe'
                            src="https://lookerstudio.google.com/embed/reporting/5d4247f9-3975-4eb4-b185-bcd2d4ca28c9/page/p_f3qeqrv8oc"
