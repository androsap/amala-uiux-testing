...
class App extends React.Component {
    ...
    render() {
        ...
        const { usepackagingvendor, usecouriercode, useprintingvendor, inventoryvariant, qty, isfree, printletter, emd, mailingproduct, orderdate,
            ordercode, status, paymenttype, paymentmethod, totalprice, currencycode, printingvendorcode, printingnotes, printingpriorityhandling,
        ...
        const branchname = (primaryDestination) ? primaryDestination.branchname : null;
        const ticketofficename = (primaryDestination) ? primaryDestination.ticketofficename : null;
        ...
        const mobileScreen = (window.innerWidth < 766);
            ...
            <React.Fragment >
                <Spin spinning={isLoading}>
                    <Row style={{ marginBottom: 5 }}>
                        ...
                        <Row style={{ marginBottom: 5 }}>
                            <Col xs={24} xl={20}>
                                <Title level={4}><Button url={`/member/form/${this.props.match.params.ID}/buy-product/form/${this.props.match.params.ordercode}`} shape='circle' icon='left' />  Tracking Status Details</Title>
                            </Col>
                            <Divider />
                        </Row>
                                ...
                                <div style={{ background: '#ffffff', height: '100%' }} >
                                            ...
                                            <Row gutter={24} type='flex' justify='end' style={{ marginTop: 15, padding: '0px 20px' }}>
                                                ...
                                                <Text style={{ display: 'block' }}>
                                                    <Tag color={(status === 'WAITING_FOR_PAYMENT' || (status === 'FAILED')) ? '#f50' : '#87d068'}>
                                                        {(status === 'SUCCESS' ? 'DELIVERED' : status || status === 'READYTODELIVER' ? 'READY TO PICKUP' : status) ? jsUcfirst(status === 'SUCCESS' ? 'DELIVERED' : status || status === 'READYTODELIVER' ? 'READY TO PICKUP' : status, '_').toUpperCase() : '-'}
                                                    </Tag>
                                                </Text>
                                            </Row>
                                        </Col>
                                    ...
                                    <Row>
                                        <Col xs={24} style={{ marginTop: 30, marginBottom: 50 }}>
                                            ...
                                            <Col xs={21} style={(mobileScreen) ? {} : { marginLeft: 20 }} offset={(mobileScreen) ? 1 : 0}>
                                                <Title level={4}>Vendor</Title>
                                                <Row>
                                                    <Col xs={24} md={12} style={(mobileScreen) ? {} : { border: '1.2px solid #ECECEC', borderTop: 'transparent', borderLeft: 'transparent', borderBottom: 'transparent', paddingRight: 20 }}>
                                                        ...
                                                        <Row style={{ marginBottom: 5 }}>
                                                            ...
                                                            <Col className='gutter-row' xs={1}>: </Col>
                                                            <Col className='gutter-row' xs={23} md={16}> <label style={{ fontSize: '15px' }}>
                                                                {(printingpriorityhandling) ? printingpriorityhandling : '-'}
                                                            </label></Col>
                                                        </Row>
                                                        <Row style={{ marginBottom: 5 }}>
                                                        ...
                                                        <Row style={{ marginBottom: 5 }}>
                                                            ...
                                                            <Col className='gutter-row' xs={1}>: </Col>
                                                            <Col className='gutter-row' xs={23} md={16}> <label style={{ fontSize: '15px' }}>
                                                                {(courierpriorityhandling) ? courierpriorityhandling : '-'}
                                                            </label></Col>
                                                        </Row>
                                                        <Row style={{ marginBottom: 5 }}>
                                                            <Col className='gutter-row' xs={24} md={7}><Text type='secondary' style={{ fontSize: '13px' }}>Order Notes</Text></Col>
                                                    ...
                                                    <Col xs={24} md={11} push={(mobileScreen) ? 0 : 1}>
                                                        ...
                                                        <Row style={{ marginBottom: 5 }}>
                                                            ...
                                                            <Col className='gutter-row' xs={1}>: </Col>
                                                            <Col className='gutter-row' xs={23} md={16}> <label style={{ fontSize: '15px' }}>
                                                                {(packagingpriorityhandling) ? packagingpriorityhandling : '-'}
                                                            </label></Col>
                                                        </Row>
                                                        <Row style={{ marginBottom: 5 }}>
                                                            <Col className='gutter-row' xs={24} md={7}><Text type='secondary' style={{ fontSize: '13px' }}>Order Notes</Text></Col>
                            ...
                            <div style={{ marginTop: 40 }} >
                                <Table dataSource={trackingstatus} size='middle' pagination={false} >
                                    ...
                                    <Column title='Status' dataIndex='status' key='status' className='nowrap' render={
                                        (value, record) => (value) ? ((value === 'READYTOPRINT') ? 'Ready to Print' :(value === 'DELIVERING') ? 'On delivery' : (value === 'READYTODELIVER') ? 'Ready to Pickup' : (value === 'READYTOPACK') ? 'Ready to Pack' : jsUcfirst(value, '_')) : '-'}
                                    />
                                    ...
                                    <Column title='Target Date' dataIndex='deadline' key='deadline' className='nowrap' render={(value, record) => (value) ? moment(value).format('DD/MM/YYYY') : '-'} />
                                    <Column title='Process Date' dataIndex='date' key='date' className='nowrap' render={(value, record) => (value) ? moment(value).format('DD/MM/YYYY') : '-'} />
                                    ...
                                    <Column title='Is Over SLA' dataIndex='isoversla' key='isoversla' width='20%' className='nowrap' render={(value, record) => (value !== undefined && value !== null) ? value === true ? 'Yes' : 'No' : 'No'} />
                                    <Column title='Overdue Days' dataIndex='overduedays' key='overduedays' className='nowrap' render={(value, record) => (value !== undefined && value !== null) ? value : '-'} />
                                </Table>
                            </div>
                        </Card>
                    </Row>
