...
class App extends Component {
    ...
    render() {
        ...
        const { countdownSession, otpsessionid, statusScreenOTP } = this.props.dataOTP;
                    ...
                    <Row>
                        <Row>
                            <Col xs={(xtraSmallWidthScreen) ? 18 : 12}>
                                <Title level={4}> <Button url={{ pathname: `/member/form/${this.props.match.params.ID}/redemptionotp` }} shape='circle' icon='left' />  {(xtraSmallWidthScreen) ? 'Redeem OTP Upgrade' : 'Redemption with OTP Upgrade'}</Title>
                            </Col>
