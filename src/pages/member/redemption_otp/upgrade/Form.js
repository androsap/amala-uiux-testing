...
import { Form, Row, Col, Divider, Typography, Spin, List, Modal, Affix, Card, Tooltip, Alert as AlertAnt, Statistic, Tag } from 'antd';
...
class App extends Component {
    ...
    componentDidMount() {
        document.title = 'Redemption OTP Upgrade | Loyalty Management System';
    ...
    render() {
        ...
        if (statusScreenOTP === 'allowed') {
            ...
            if (isSuccessBuy) {
                return (<Redirect to={{ pathname: `/member/form/${memberid}/redemptionotp/upgrade/${awardcode}/certificate`, state: { responseBuyAward } }} />)
            } else {
                return (
                    <Row>
                        {
                            (modalType === 'DEPARTURE') ?
                                <Modal visible={visibleDepr} title='Use Promo' loading={isLoading} onCancel={this.handleCloseModal} footer={null} destroyOnClose={true} width={680}>
                                    <UsePromo onClose={this.handleOk} {...this.props} modalType={modalType} flightnumberdeparture={flightnumberdeparture} cardnumber={cardnumber}
                                        setStateOfParent2={this.setStateOfParent2} awardinfo={awardinfo} selectFlightDeparture={selectFlightDeparture} />
                        ...
                        <Row gutter={[20, 20]}>
                            <Title level={4}>
                                <Col xs={24} xl={12}>
                                    <Button url={{ pathname: `/member/form/${memberid}/redemptionotp/upgrade/${awardcode}`, state: { ...this.props.location.state } }} shape='circle' icon='left' /> Redemption Upgrade
                                </Col>
                                <Col xs={24} xl={12}>
                        ...
                        <Spin spinning={isLoading}>
                            <Form {...formItemLayout} onSubmit={this.saveAction}>
                                        ...
                                        <Row className={(!roundtrip && selectFlightDeparture !== null) || (roundtrip && selectFlightDeparture !== null) ? '' : 'hidden'}>
                                            <Col className='gutter-row' xs={24} sm={24} md={24} lg={{ span: 22, pull: 2 }} xl={{ span: 22, pull: 2 }}>
                                                ...
                                                <Row gutter={24}>
                                                    ...
                                                    <Col xs={24} lg={6}>
                                                        <Button htmlType='button' size='medium' label='Promo List' onClick={(e) => this.handleOpenModal(e, 'DEPARTURE')} style={{ marginTop: 3 }} disabled={(this.props.form.getFieldValue('flightnumberdeparture')) ? false : true} />
                                                    </Col>
                                                </Row>
                                            </Col>
                                        </Row>
                                                        ...
                                                        <Row className={(roundtrip && selectFlightDeparture !== null && selectFlightReturn !== null) ? '' : 'hidden'}>
                                                            <Col className='gutter-row' xs={24} sm={24} md={24} lg={{ span: 22, pull: 2 }} xl={{ span: 22, pull: 2 }}>
                                                                ...
                                                                <Row gutter={24}>
                                                                    ...
                                                                    <Col xs={24} lg={6}>
                                                                        <Button htmlType='button' size='medium' label='Promo List' onClick={(e) => this.handleOpenModal(e, 'RETURN')} style={{ marginTop: 3 }} disabled={(this.props.form.getFieldValue('flightnumberreturn')) ? false : true} />
                                                                    </Col>
                                                                </Row>
                                                            </Col>
                                                        </Row>
                                ...
                                <Col className='gutter-row' xs={24} sm={24} md={24} lg={8} xl={8} style={{ padding: '0 10px' }}>
                                    <Affix offsetTop={24}>
                                        <div>
                                            <Card title='Award Information' bordered={false} style={{ boxShadow: '0 2px 5px 0 rgba(27,27,27,.1)', borderRadius: '12px 12px 0px 0px' }} bodyStyle={{ padding: '5px', paddingBottom: '12px' }}>
                                                <Row style={{ margin: '0px 20px' }}>
                                                    <Col xs={24} lg={12}>Award Code</Col>
                                            ...
                                            <Card title='Price Details' bordered={false} style={{ boxShadow: '0 2px 5px 0 rgba(27,27,27,.1)', marginTop: '5px', borderRadius: '0px 0px 12px 12px' }} bodyStyle={{ paddingTop: '5px', paddingBottom: '5px' }}>
                                                <Row>
                                                ...
                                                <Row style={{ paddingTop: '16px', borderTop: '1px solid #e8e8e8', marginTop: '12px', marginBottom: '12px' }}>
                                                    <Col xs={24} sm={24} md={24} lg={18} xl={18}>
