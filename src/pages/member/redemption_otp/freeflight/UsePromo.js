...
class UsePromo extends Component {
    ...
    retrieveData = (promocode) => {
        ...
        const { price, airlinecode, bookingclasscode, compartmentcode, origin, destination, flightdate } = (modalType === 'DEPARTURE') ? dataList.departure[selectFlightDeparture] : dataList.return[selectFlightReturn] || {};
