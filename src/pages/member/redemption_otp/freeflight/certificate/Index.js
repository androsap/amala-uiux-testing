...
import { Form, Row, Col, Divider, Typography, Button, Statistic, Tag } from 'antd';
...
class Layout extends Component {
    ...
    componentDidMount() {
        ...
        if (state === undefined) {
            ...
            const { awardcode, awardtypename, totalprice, issueddate, freeaward, bookingcode, redeemairactivity, redeemvoucherdetail, voucherimage } = responseBuyAward;
