...
import { Card, Row, Col, Typography, Form, Divider, Spin, Statistic } from 'antd';
    ...
    render() {
        ...
        if (validate) {
            ...
            if (isSuccessSelect) {
                ...
                if (departurestatus === 'VOUCHER_ISSUED') {
                ...
                if (returnstatus === 'VOUCHER_ISSUED') {
                ...
                return (
                    <Row>
                        <Col xs={24} xl={20} >
                            <Title level={4}><Button url={'/member/form/' + memberid + 'certificateotp'} shape="circle" icon="left" /> Update Certificate</Title>
                        </Col>
                        <Col xs={24} xl={3} >
                                ...
                                <Row>
                                    ...
                                    <Card title="Activity Details" bordered={false} style={{ marginBottom: 10 }} className="card-shadow">
                                        <Row className="pricelist-flight-header">
                                            ...
                                            <Col xs={24} sm={24} md={24} lg={5} xl={3}> Airline / Flight Number </Col>
                                        ...
                                        <Row className="pricelist-flight">
                                            ...
                                            <Col xs={24} sm={24} md={24} lg={5} xl={3}> {departureairlinecode} / {departureflightnumber} </Col>
                                            ...
                                            <Col xs={24} sm={24} md={24} lg={5} xl={2}>
                                                {/* {
                                        ...
                                        <Row className={(roundtrip) ? "pricelist-flight" : "hidden"}>
                                            ...
                                            <Col xs={24} sm={24} md={24} lg={5} xl={3}> {returnirlinecode} / {returnflightnumber} </Col>
