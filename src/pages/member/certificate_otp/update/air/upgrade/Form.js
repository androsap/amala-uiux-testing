...
class App extends Component {
    ...
    async componentDidMount() {
        ...
        /*Variable props */
        let deprpromocode = flightdeparture ? (flightdeparture.promocode ? flightdeparture.promocode : null) : null;
        let discountamountdepr = flightdeparture ? (flightdeparture.discountamount ? flightdeparture.discountamount : null) : null;
        let deprprice = flightdeparture ? (flightdeparture.price ? flightdeparture.price : null) : null;
        let retrpromocode = flightreturn ? (flightreturn.promocode ? flightreturn.promocode : null) : null;
        let discountamountretr = flightreturn ? (flightreturn.discountamount ? flightreturn.discountamount : null) : null;
        let retrprice = flightreturn ? (flightreturn.price ? flightreturn.price : null) : null;
                ...
                if (responsecode === "0000") {
                    ...
                    if (fromApproval) {
                        ...
                        if (typeButton === 'UPDATE') {
                            this.setState({ isLoading: false, isSuccessBuy: true, newcertificateid: redeemuser.certificateid });
                        } else this.props.history.push(`/member/form/${memberid}certificateotp`);
                    }
                } else {
    ...
    calculationFee(standarfee) {
        ...
        if (standarfee && updateunit === 'PERCENTAGE') {
            ...
            } else fee = Math.ceil(certificateprice * updatefee / 100);
        } else if (standarfee && updateunit === 'MILEAGE') fee = updatefee;
    ...
    render() {
        ...
        const { promocodedepr, promocoderetr, discountdepr, discountretr, pricedeparture, pricereturn, awardinfo, discountamountdepr, deprprice, retrpromocode, discountamountretr, showsave,
            totalafterdiscountdepr, totalafterdiscountretr, discounttypedepr, discounttyperetr, totaldiscountdepr, totaldiscountretr, isLoading, isSuccessBuy, retrprice, showConfirmation, fieldvalue,
            flightDeparture, flightReturn, selectFlightDeparture, selectFlightReturn, requestSearchFlight, mileageDeparture, mileageReturn, newcertificateid, deprpromocode, typeButton, } = this.state;
        const { adultpassenger } = requestSearchFlight;
        ...
        let totalMileage = (manualPricing) ? ((roundtrip) ? ((pricereturn && pricedeparture) ? formatNumber((Number(pricedeparture) + Number(pricereturn)) * adultpassenger) : null) :
            ((pricedeparture) ? formatNumber(Number(pricedeparture) * adultpassenger) : null)) : formatNumber(this.state.totalMileage);
                        ...
                        <Spin spinning={this.state.isLoading}>
                            <Form {...formItemLayout} onSubmit={this.showConfirmation}>
                                <Row>
                                    <Col className="gutter-row" xs={24} sm={24} md={24} lg={16} xl={16}>
                                                ...
                                                <List
                                                    ...
                                                    renderItem={(item, key) => (
                                                        <Row className="pricelist-flight">
                                                            ...
                                                            <Col xs={24} lg={(manualPricing) ? 6 : 4}>{(item.origin) ? item.origin : '-'} - {(item.destination) ? item.destination : '-'}</Col>
                                        ...
                                        <Row className={((!roundtrip && selectFlightDeparture !== null) || (roundtrip && selectFlightDeparture !== null && selectFlightReturn !== null)) ? '' : 'hidden'}>
                                            ...
                                            <Col className="gutter-row" xs={24} sm={24} md={24} lg={{ span: 21, offset: 2 }} xl={{ span: 21, offset: 2 }}>
                                                ...
                                                <InputText wrapperCol={{ span: 10 }} labelCol={{ span: 8 }} form={this.props.form} labeltext="Departure Flight Number" datafield="flightnumberdeparture" validationrules={['required', 'pattern.number']} maxLength={4} disabled={!activitydepartureselected} />
                                                {
                                                    (roundtrip) ? <span>
                                                        ...
                                                        <InputText wrapperCol={{ span: 10 }} labelCol={{ span: 8 }} form={this.props.form} labeltext="Return Flight Number" datafield="flightnumberreturn" validationrules={['required', 'pattern.number']} maxLength={4} disabled={!activityreturnselected} />
                                                    </span> : null
                                                }
                                            </Col>
                                        </Row>
                                        ...
                                        <Row className={((!roundtrip && selectFlightDeparture !== null) || (roundtrip && selectFlightDeparture !== null && selectFlightReturn !== null)) ? '' : 'hidden'}>
                                            ...
                                            <Col className="gutter-row" xs={24} sm={24} md={24} lg={{ span: 20, offset: 2 }} xl={{ span: 20, offset: 2 }}>
                                                ...
                                                <DatePickerBase wrapperCol={{ span: 10 }} labelCol={{ span: 8 }} form={this.props.form} labeltext="Ticket Validity Date" datafield="ticketvaliditydate" minDate={moment(new Date())} disabled={true} />
                                                <InputText wrapperCol={{ span: 10 }} labelCol={{ span: 8 }} form={this.props.form} labeltext="Paid Ticket Number" datafield="ticketnumber" validationrules={['pattern.alphanumeric']} maxLength={13} disabled={true} />
                                    ...
                                    <Col className="gutter-row" xs={24} sm={24} md={24} lg={8} xl={8} style={{ padding: '0 px' }}>
                                        <Affix offsetTop={0}>
                                            <div>
                                                    ...
                                                    <Row>
                                                        <Col xs={24} sm={24} md={24} lg={18} xl={18}>
                                                            ...
                                                            <Text style={{ display: 'block' }}>
                                                                {
                                                                    (selectFlightDeparture !== null) ? ` ${summaryDepartureFlight.origin}-${summaryDepartureFlight.destination} / ${summaryDepartureFlight.airlinecode} / ${summaryDepartureFlight.compartmentcode} / ${summaryDepartureFlight.bookingclasscode} (x ${adultpassenger} )` : "-"
                                                                }
                                                            </Text>
                                                        ...
                                                        (roundtrip) ?
                                                            <Row style={{ marginTop: '5px' }}>
                                                                <Col xs={24} sm={24} md={24} lg={18} xl={18}>
                                                                    ...
                                                                    <Text style={{ display: 'block' }}>
                                                                        {
                                                                            (selectFlightReturn !== null) ? summaryReturnFlight.origin + " - " + summaryReturnFlight.destination + " / " + summaryReturnFlight.airlinecode + " / " + summaryReturnFlight.compartmentcode + " / " + summaryReturnFlight.bookingclasscode + " (x " + adultpassenger + ")" : "-"
                                                                        }
                                                                    </Text>
                                                                    <Text style={{ display: 'block', marginLeft: 30 }}>
                                                                        {
