...
class App extends React.Component {
    ...
    render() {
        ...
        const { countdown, validate } = this.props;
        ...
        if (validate) {
            return (
                <Row>
                    ...
                    <Divider />
                    <Certificate {...this.props} number={1} certificateid={certificateid} />
                    <Col style={{ textAlign: 'center' }} xs={24} sm={24} md={24} lg={24} xl={24}>
                        <Link to={"/member/form/" + memberid + "/certificate"}>
                            <Button url={'/member/form/' + memberid + '/certificateotp'} label="Certificate List" />
                        </Link>
