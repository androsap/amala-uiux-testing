...
class Layout extends Component {
    ...
    componentDidMount() {
        ...
        if (state === undefined) {
            ...
            const { responseBuyAward } = this.props.location.state;
            const { awardcode, awardtypename, totalprice, issueddate, freeaward, bookingcode, redeemairactivity, redeemvoucherdetail, voucherimage, ticketnumber, ticketvaliditydate } = responseBuyAward;

            let redeemUserFinal = [];
            let redeemuser = responseBuyAward.redeemuser;
            for (const field in redeemuser) {
                ...
                redeemUserFinal[field]['certificatedetails']['ticketvaliditydate'] = (ticketvaliditydate !== undefined) ? moment(ticketvaliditydate).format("DD/MM/YYYY") : '-';;
                ...
                redeemUserFinal[field]['activitydetails']['roundtrip'] = responseBuyAward.return;
