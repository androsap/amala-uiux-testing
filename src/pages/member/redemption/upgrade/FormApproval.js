...
import { Form, Row, Col, Divider, Typography, Spin, List, Modal, Affix, Card, Button as AntButton, Tooltip, Alert as AlertAnt } from 'antd';
...
class App extends Component {
    ...
    componentDidMount() {
        ...
        if (state === undefined) {
            ...
            this.props.form.setFieldsValue({
                ...
                ticketvaliditydate: moment(ticketvaliditydate), [`passenger-travelertype0`]: travelertype, flightnumberdeparture: redeemairactivity.departure[0].flightnumber
            });
        }
    }
    ...
    saveAction = (e) => {
        ...
        const callback = (input) => {
            ...
            const { awardcode, adultpassenger, memberid, username, roundtrip, paidcompartmentcodedepart, paidcompartmentcodereturn } = this.state.requestSearchFlight;
            const { selectFlightDeparture, selectFlightReturn, flightDeparture, flightReturn, totalafterdiscountdepr, totalafterdiscountretr, summaryafterdiscountdepr, summaryafterdiscountretr, promocodedepr, promocoderetr } = this.state;
            ...
            departureActivity = {
                ...
                paidbookingclasscode: departureActivity.paidbookingclassdepart,
            ...
            if (roundtrip) {
                ...
                returnActivity = {
                    ...
                    paidcompartmentcode: (returnActivity.paidcompartmentcodedepart) ? returnActivity.paidcompartmentcodedepart : paidcompartmentcodereturn,
                    paidbookingclasscode: returnActivity.paidbookingclassdepart,
                    bookingtype: "INTERNET"
                }
            }
            ...
            else if (totalafterdiscountretr !== null && totalafterdiscountdepr === null) { totalprice = ((totalafterdiscountretr + mileageDeparture) * adultpassenger) }
            else if (totalafterdiscountdepr !== null && totalafterdiscountretr !== null) { totalprice = ((totalafterdiscountdepr + totalafterdiscountretr) * adultpassenger) }
            else if (totalafterdiscountdepr === null && totalafterdiscountretr === null) { totalprice = ((mileageDeparture + mileageReturn) * adultpassenger) }
            ...
            let data = {
                requestid, referenceid, memberid, requesttype, requeststatus, approvalby, approvaldate, remark: (input.remark) ? input.remark : null, reqdata, createdBy, isdataactive, reqdatas: {
                    ...
                    totalprice, redeemuser, redeemairactivity, remark: (input.remark) ? input.remark : null, return: roundtrip, categorycode
                }
            };
    ...
    handleBackSearchFlight = () => {
        this.props.handleBackSearchFlight(this.state.requestSearchFlight)
    }
    ...
    render() {
        ...
        const { spinloading, flightnumberdeparture, flightnumberreturn, cardnumber, promocodedepr, promocoderetr, discountdepr, discountretr, showsave,
            totalafterdiscountdepr, totalafterdiscountretr, discounttypedepr, discounttyperetr, totaldiscountdepr, totaldiscountretr } = this.state;
                                                ...
                                                <Row className="pricelist-flight">
                                                    ...
                                                    <Col xs={24} sm={24} md={24} lg={4} xl={4}>
                                                        <Button htmlType="button" type={(key === selectFlightDeparture) ? 'primary' : 'default'} size="small" label="Select"
                                                            ...
                                                            disabled={selectFlightDeparture !== null && selectFlightDeparture !== key && totalafterdiscountdepr}
                                                        />
                                                    </Col>
                                                </Row>
                                            )}
                                        ...
                                        <Row>
                                            <Row>
                                                <Col className="gutter-row" xs={24} sm={24} md={24} lg={24} xl={24}>
                                                    ...
                                                    <Row className="pricelist-flight-header">
                                                        <Col xs={24} sm={24} md={24} lg={4} xl={4}>Activity Date</Col>
                                                        <Col xs={24} sm={24} md={24} lg={5} xl={5}>Airline</Col>
                                                    ...
                                                    <List
                                                        ...
                                                        renderItem={(item, key) => (
                                                            <Row className="pricelist-flight">
                                                                ...
                                                                <Col xs={24} sm={24} md={24} lg={4} xl={4}>
                                                                    <Button htmlType="button" type={(key === selectFlightReturn) ? 'primary' : 'default'} size="small" label="Select"
                                                                        onClick={(e) => this.handleSelectFlight(e, 'RETURN', key)}
                                                                        disabled={selectFlightReturn !== null && selectFlightReturn !== key && totalafterdiscountretr}
                                                                    />
                                                                </Col>
                                                            </Row>
                                                        )}
                            ...
                            <Col className="gutter-row" xs={24} sm={24} md={24} lg={8} xl={8} style={{ padding: '0 10px' }}>
                                <Affix offsetTop={0}>
                                    <div>
                                        ...
                                        <AntButton htmlType="button" type="primary" block style={{ marginTop: '20px' }} onClick={this.showSave}
                                            disabled={((!roundtrip && selectFlightDeparture !== null) || (roundtrip && selectFlightDeparture !== null && selectFlightReturn !== null)) ? false : true}> Update Request </AntButton>
                                        <AntButton htmlType="button" type="default" block style={{ marginTop: '20px' }} onClick={this.handleBackSearchFlight}> Back to Search Flight </AntButton>
                                    </div>
                                </Affix>
                            </Col>
                        </Form>
