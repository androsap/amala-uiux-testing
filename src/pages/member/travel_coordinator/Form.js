                    ...
                    <Form {...formItemLayout} onSubmit={this.saveAction}>
                        <Row gutter={24}>
                            <Col className="gutter-row" xs={24} sm={24} md={24} lg={{ span: 18 }} xl={{ span: 18 }}>
                                ...
                                <InputText form={this.props.form} labeltext="Card Number" datafield={`admin[0][cardnumber]`} validationrules={['pattern.number', 'required']} maxLength={20} onBlur={(e) => this.handleAutoFill(e, 'admin', 0)} disabled={true} />
                                ...
                                <InputText form={this.props.form} labeltext="ID Card Number" datafield={`admin[0][idcardnumber]`} validationrules={['pattern.number', 'required']} maxLength={20} disabled={true} />
