...
import { Button, Alert, SearchForm, PartnerSelect, TierSelect, BranchSelect, TicketOfficeSelect } from '../../components/Base/BaseComponent';
...
class App extends React.Component {
    ...
    componentDidMount() {
        document.title = "Non Air Accrual Report | Loyalty Management System";
    ...
    handleDownloadModal = () => {
        const callback = () => {
            let url = api.url.nonairaccrualreport.generate;
    ...
    handleInsertDateFrom = (insertdatefrom) => {
        ...
        if (!insertdatefrom && !activitydatefrom) {
            ...
            this.props.form.setFieldsValue({
                partner: undefined, memberstatus: undefined, tier: undefined, cardnumber: undefined
            })
        }
    }
    ...
    render() {
        ...
        const { insertdatetodisabled, activitydatetodisabled } = fielddisabled;
        ...
        const configurationTable = {
            url: api.url.nonairaccrualreport.list,
            columnClassName: "nowrap",
            columns: [
                { type: 'field', title: 'Transaction ID', dataIndex: 'transactionid', sorter: true },
                {
                    type: 'field', title: 'Insert Date', dataIndex: 'inserteddate', sorter: true,
                    render: (value) => { return (value) ? moment(value).format('DD/MM/YYYY') : '' }
                },
                {
                    type: 'field', title: 'Transaction Date', dataIndex: 'transactiondate', sorter: true,
                    render: (value) => { return (value) ? moment(value).format('DD/MM/YYYY') : '' }
                },
                ...
                { type: 'field', title: 'Partner Activity SEQ', dataIndex: 'partneractivityseq', sorter: true },
                ...
                { type: 'field', title: 'Billing Base Points', dataIndex: 'billingbasepoint', sorter: true },
                { type: 'field', title: 'Billing Bonus Points', dataIndex: 'billingbonuspoint', sorter: true },
                { type: 'field', title: 'Billing Base Rate', dataIndex: 'billingbaserate', sorter: true },
                { type: 'field', title: 'Billing Bonus Rate', dataIndex: 'billingbonusrate', sorter: true },
                ...
                { type: 'field', title: 'SO Code', dataIndex: 'socode', sorter: true },
        ...
        return (
            <Layout>
                <Layout.Content style={{ margin: '16px 0', padding: '24px', minHeight: 500, background: '#fff', boxShadow: '0 1px 15px 1px rgba(69,65,78,.1)' }}>
                    <Row>
                        <Col xs={24} xl={22}>
                            <Title level={3}>Non Air Accrual Report</Title>
                        </Col>
                        <Divider />
                    </Row>
