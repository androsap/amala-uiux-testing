...
class App extends React.Component {
    ...
    componentDidMount = async () => {
        document.title = "Accounting Report | Loyalty Management System";
    };
                ...
                <Layout>
                    <Layout.Content style={{ minHeight: 500, background: '#fff' }}>
                        <Iframe id='embeddedIframe'
                            src="https://lookerstudio.google.com/embed/reporting/790b6802-301e-4275-b388-84cf45e221fc/page/NHAzC"
