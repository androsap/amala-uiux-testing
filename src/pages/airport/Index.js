...
class App extends React.Component {
    componentDidMount() {
        document.title = "Manage Airport | Loyalty Management System";
    }
    ...
    render() {
        ...
        const configurationTable = {
            url: api.url.airport.list,
            columns: [
                { type: 'field', title: 'IATA Code', dataIndex: 'airportiatacode', sorter: true },
                { type: 'field', title: 'Airport Name', dataIndex: 'airportname', sorter: true },
                ...
                },
                {
                    ...
                    render: (value, row, index) => {
                        return (
                            <span>
                                <Button url={'/airport/form/' + row.airportiatacode} size="small" label="Edit" menucode={menucode} prefixmenuname={prefixmenuname} actioncode="UPDATE" />
                            </span>
                        )
                    }
                },
        ...
        const configurationSearchForm = [
            { labeltext: "IATA Code", datafield: "airportiatacode", type: 'text', placeholder: 'IATA Code', showDefaultSearch: true },
            { labeltext: "Airport Name", datafield: "airportname", type: 'text', placeholder: 'Airport Name', showDefaultSearch: true },
        ...
        return (
            <React.Fragment>
                <Row>
                    <Col xs={24} xl={22}>
                        <Title level={3}>Manage Airport</Title>
                    </Col>
                    <Col xs={24} xl={2}>
                        <Button type="primary" url={'/airport/form/'} size="default" label="Add New" menucode={menucode} prefixmenuname={prefixmenuname} actioncode="CREATE" />
                    </Col>
                    <Divider />
                </Row>
