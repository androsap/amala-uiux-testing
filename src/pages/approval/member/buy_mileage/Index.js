...
class App extends React.Component {
    ...
    async componentDidMount() {
        document.title = 'Manage Approval Buy Mileage | Loyalty Management System';
        await this.getUser();
    ...
    handleSearchForm = (criteria, type) => {
        ...
        if (startdate === null && enddate === null && requestid === null && approvaldate === null && approvalby === null && cardnumber === null && requeststatus === null && createddate === null && createdBy === null && tab2clicked) {
            ...
            criteria.requesttype = this.props.pagetype ? this.props.pagetype : 'BUYMILEAGE';
    ...
    render() {
        const { menucode, prefixmenuname, location } = this.props;
        const { searching, tab2clicked, tickoffid, ignoretickoffid, tab2Search, ApprovalByData, IssuedByData } = this.state;
        ...
        let configurationSearchForm = [
            ...
            { labeltext: 'Approval Status', datafield: 'requeststatus', type: 'select', placeholder: 'Approval Status', showDefaultSearch: true, options: (!tab2clicked ? ApprovalStatus.slice(0, 3) : ApprovalStatus.slice(3, 6)) },
        ...
        const configurationTable = {
            ...
            criteria: ignoretickoffid ? { requesttype: 'BUYMILEAGE', isdataactive: !tab2clicked } : { requesttype: 'BUYMILEAGE', isdataactive: !tab2clicked, tickoffid },
        ...
        return (
            <React.Fragment>
                <Row>
                    <Col xs={24} xl={20}>
                        <Title level={3}>Manage Approval Buy Mileage</Title>
                    </Col>
                    <Divider />
                </Row>
