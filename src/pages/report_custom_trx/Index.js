...
class App extends React.Component {
    ...
    componentDidMount() {
        document.title = "Custom Transaction Report | Loyalty Management System";
    ...
    handleDownloadModal = () => {
        const callback = () => {
            let url = (this.state.reportype === 'HISTORICAL') ? api.url.customtrxreport.generate : api.url.customtrxreport.dailygenerate;
    ...
    render() {
        ...
        const { insertdatefromdisabled, insertdatetodisabled, activitydatetodisabled } = fielddisabled;
        ...
        const configurationTable = {
            url: (reportype === 'HISTORICAL') ? api.url.customtrxreport.list : api.url.customtrxreport.dailylist,
            ...
            columns: [
                ...
                { type: 'field', title: 'Custom Transaction Code', dataIndex: 'customtransactioncode', sorter: true },
        ...
        return (
            <Layout>
                <Layout.Content style={{ margin: '16px 0', padding: '24px', minHeight: 500, background: '#fff', boxShadow: '0 1px 15px 1px rgba(69,65,78,.1)' }}>
                    <Row>
                        <Col xs={24} xl={22}>
                            <Title level={3}>Custom Transaction Report</Title>
                        </Col>
                        <Divider />
                    </Row>
