...
class App extends Component {
    ...
    getDetail = (awardcode) => {
        ...
        DetailRequest(url, data).then((response) => {
            ...
            if (status.responsecode.substring(0, 1) === '0') {
                let fixprice = (result.fixprice) ? result.fixprice.toString() : undefined;

                let setValue = { fixprice };
    ...
    saveAction = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, input) => {
            if (!err) {
                ...
                let fixprice = input.fixprice;
                let pricestatus = true;

                let message = 'Data has been updated';
                let url = api.url.awardmaster.updatefixedprice;
                let data = { awardcode, fixprice, pricestatus };
    ...
    render() {
        ...
        if (formrender) {
            ...
            document.title = titlepage + " Price | Loyalty Management System";
            //render form
            return (
                <Row>
                    <Row>
                        ...
                        <Form {...formItemLayout} onSubmit={this.saveAction}>
                            <Row gutter={24}>
                                <Col className="gutter-row" xs={24} sm={24} md={24} lg={{ span: 12, offset: 4 }} xl={{ span: 12, offset: 4 }}>
                                    <InputText form={this.props.form} labeltext="Price" datafield="fixprice" validationrules={['required', 'pattern.number', 'max.10',]} maxLength="10" disabled={generalfielddisabled} />
                                </Col>
                            </Row>
