...
class Layout extends Component {
    ...
    /*getSearchFlight() {
        let flightscheduledeparture = this.props.redemption.pricelist.priceDeparture;
        let flightschedulereturn = this.props.redemption.pricelist.priceReturn;
        this.setState({ flightscheduledeparture, flightschedulereturn });
    }*/
    ...
    handleSelectFlight = (e, selectflight) => {
        ...
        this.setState({
            ...
            redemptionsummary: {
                ...
                flightreturn: {},
                mileage, passenger, totalmileage,
                certificateprice,
                activityprice
            },
            selectflight,
                                                    ...
                                                    } */}
                                                    {
                                                        (searchflight && !searchflight.isreturn) ?
                                                            <div className="form-group row">
                                                                ...
                                                                <h4 className="col-sm-9 text-right">{formatNumber(redemptionsummary.totalmileage)} Milage ({passenger} Pax) </h4>
                                                            </div> : ""
                                                    }
                                                    {
                                                        (searchflight && !searchflight.isreturn) ?
