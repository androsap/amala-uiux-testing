...
class Layout extends Component {
    ...
    render() {
        ...
        const { flightschedulereturn, selectflight, award } = this.state;
        ...
        const { searchflight, redemptionsummary, confirmdisabled, freeaward } = this.state;
                                                    ...
                                                    } */}
                                                    {
                                                        (selectflight !== null) ?
                                                            <div className="form-group row">
                                                                ...
                                                                <h4 className="col-sm-9 text-right">{formatNumber(redemptionsummary.totalmileage)} Milage ({(searchflight) ? searchflight.passenger : 0} Pax)</h4>
                                                            </div> : ""
                                                    }
                                                    <div className="form-group row">
