...
class Layout extends Component {
    ...
    handleValidation(field) {
        ...
        //  else if (field['departuredate'] < today) {
        //     errors['departuredate'] = 'The day after today';
        // }
    ...
    saveAction = (e) => {
        ...
        if (this.handleValidation(formData)) {
            ...
            const { origin, destination, airlinecode, compartmentcode, isreturn } = this.state;
    ...
    handleIsReturnChange = (event) => {
        ...
        this.setState({ returndatedisabled, returndate, isreturn });
    }
    ...
    handleDepartureDateChange = (event) => {
        ...
        this.setState({ departuredate, returndate, minreturndate });
    }
    ...
    handleAirlineChange = (event) => {
        ...
        this.setState({ airlinecode, compartmentcode, compartmentcodedisabled });

        if (airlinecode) { this.getOptionsCompartment(airlinecode) }
    }

    render() {
        const { loading, errors, isLoadingSelect2, returndatedisabled, compartmentcodedisabled } = this.state;
        const { optionsAirportDestination, optionsAirportOrigin, optionsCompartment, optionsAirline } = this.state;
        const { origin, destination, departuredate, returndate, minreturndate, compartmentcode, airlinecode } = this.state;
                    ...
                    <div className="main-panel mt-3">
                        ...
                        <div className="row">
                            <div className="col-sm-6">
                                ...
                                <div className="form-group">
                                    <label className="col-sm-4 col-form-label" htmlFor="origin-view">From </label>
                                    <div className="col-sm-8">
                                ...
                                <div className="form-group">
                                    <label className="col-sm-4 col-form-label" htmlFor="passenger-view">No. of Passenger </label>
                                    <div className="col-sm-8">
                                        <input className="form-control" type="number" id="passenger-view" ref="passenger" min="1" max={maxperson} defaultValue="1" onChange={this.handlePassengerChange} />
                            ...
                            <div className="col-sm-6">
                                <div className="form-group">
                                    ...
                                    <div className="col-sm-8">
                                        <Select2 reference="compartmentcode" className="reactSelect2" id="compartmentcode-view" options={optionsCompartment} onChange={this.handleCompartmentChange} value={optionsCompartment.filter(({ value }) => value === compartmentcode)} isLoading={isLoadingSelect2.compartmentcode} disabled={compartmentcodedisabled}></Select2>
                                        <span className="text-danger">{errors["compartmentcode"]}</span>
                                    </div>
                                </div>
                                <div className="form-group">
                                    <label className="col-sm-4 col-form-label" htmlFor="destination-view">To </label>
                                    <div className="col-sm-8">
                                ...
                                <div className="form-group">
                                    <label className="col-sm-4" htmlFor="returndate-view">
                                    ...
                                    <div className="col-sm-8">
                                        <Datepicker className="form-control" id="returndate-view" onChange={this.handleReturnDateChange} selected={returndate} dateFormat={"DD/MM/YYYY"} disabled={returndatedisabled} minDate={minreturndate} />
