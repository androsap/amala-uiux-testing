...
class Layout extends Component {
    ...
    componentWillMount() {
        const { redeemvoucherdetail, redeemairactivity, redeemusers, voucherimage, totalprice, issueddate, freeaward, bookingcode, awardcode, awardtypename } = this.props.redemption.responsebuyaward;
        let vouchertext = [];
        ...
        this.setState({
            ...
            canvassourcevoucher: [], cardnumber
        })
    }
