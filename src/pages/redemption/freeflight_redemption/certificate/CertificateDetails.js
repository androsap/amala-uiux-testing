...
class Layout extends Component {
    ...
    componentWillReceiveProps(props) {
        const { certificateid, awardcode, awardtype, totalprice, issueddate, freeaward, bookingcode, status, numbercertificate } = props.data;
        this.setState({ certificateid, awardcode, awardtype, totalprice, issueddate, freeaward, bookingcode, status, numbercertificate });
    }

    render() {
        const { certificateid, awardcode, awardtype, totalprice, issueddate, freeaward, bookingcode, status, numbercertificate } = this.state;
        return (
