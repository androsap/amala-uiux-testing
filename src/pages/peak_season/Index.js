...
class App extends React.Component {
    ...
    componentDidMount() {
        document.title = "Manage Peak Season | Loyalty Management System";
    }
    ...
    deleteData(peakseasoncode) {
        let url = api.url.peakseason.delete;
    ...
    render() {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (value, row, index) => {
                        return (
                            <span>
                                <Button url={'/peak-season/form/' + row.peakseasoncode} size="small" label="Edit" menucode={menucode} prefixmenuname={prefixmenuname} actioncode="UPDATE" />
                                <Button htmlType="button" size="small" label="Delete" type="danger" menucode={menucode} prefixmenuname={prefixmenuname} actioncode="DELETE" onClick={() => this.deleteData(row.peakseasoncode)} />
                            </span>
                        )
                    }
                },
        ...
        return (
            <React.Fragment>
                <Row>
                    <Col xs={24} xl={22}>
                        <Title level={3}>Manage Peak Season</Title>
                    </Col>
                    <Col xs={24} xl={2}>
                        <Button type="primary" url={'/peak-season/form/'} label="Add New" menucode={menucode} prefixmenuname={prefixmenuname} actioncode="CREATE" />
                    </Col>
                    <Divider />
                </Row>
