...
export class Index extends Component {
    constructor(props){
        ...
        this.methods = {
            ...
            onChange: (e) => {
                ...
                if(onChange) onChange(e.target.value, {data: e.target.data,...this.props.methods});
            },
            validation: () => {
    ...
    render() {
        ...
        const { formItemLayout, validation, positionCheckbox, onChange } = this.methods;
        ...
        return (<Spin spinning={spinning}>
            ...
            >
                {getFieldDecorator(dataField, {
                    ...
                    <Radio.Group {...editorOptions} onChange={onChange}>
                        {items.map(item => {
                            return <Radio
                                key={item.valueExpr}
